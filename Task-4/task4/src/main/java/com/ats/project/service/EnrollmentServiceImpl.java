...
public class EnrollmentServiceImpl implements EnrollmentService {
    ...
    public EnrollmentServiceImpl(EnrollmentRepo enrollmentRepo, CoursesService coursesService, CoursesRepository coursesRepository, StudentsRepository studentsRepository) {
    ...
    public void addEnrollment(Enrollment enrollment) throws RuntimeException{
        ...
        for (Courses course : enrollment.getCourse().getPrerequisiteCourses()) {
            if(enrollment.getStudent().getCompletedCourses() != null && !enrollment.getStudent().getCompletedCourses().isEmpty()){
