...
//
//		c3.getPrerequisiteCourses().add(c1);
//		c4.getPrerequisiteCourses().add(c2);
//		coursesService.CreateCourses(c1);
//		coursesService.CreateCourses(c3);
//		coursesService.CreateCourses(c2);
...
//		coursesService.findById(1L).orElse(null),
...
//
		...
		Students student = studentsService.findById(1L).orElseThrow(()-> new RuntimeException("student not found"));
		double gpa = studentsService.calculateGpa(student);
		System.out.println("GPA: " + gpa);
		System.out.println("completed courses for student with ID 1:");
//		student.getCompletedCourses().forEach(c->System.out.println(" - " + c.getName() + " | " + c.getId()));
		System.out.println("====================================================================================================");

//
		try{

		Enrollment enrollment = new Enrollment(studentsService.findById(3L).orElse(null),
				coursesService.findById(5L).orElse(null),true, Grade.C, Semester.SPRING_2025, EnrollmentStatus.COMPLETED);
